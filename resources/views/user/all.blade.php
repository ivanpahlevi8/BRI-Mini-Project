        ...
        <div class="row">
            ...
            <div class="card mb-grid">
                @if($role->role == "admin" || $role->role == "Staff")
                    <a type="button" class="btn btn-primary" href="/add-user">+ Asisten Baru</a>
                @endif
                                ...
                                <table class="table table-actions table-striped table-hover mb-0 dataTable no-footer" data-table="data-table" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{$item->id_assisten}}</td>
                                            <td>{{$item->name}}</td>
                                            <td>{{$item->created_at}}</td>
                                            <td>{{$item->role}}</td>
                                            <td>{{$item->email}}</td>
                                            <td>
                                                <a class="btn btn-sm btn-primary" href="/update-user/{{ $item->id }}">Edit</a>
                                                <form>
                                                <a class="btn btn-sm btn-danger" href="/delete-user/{{ $item->id }}">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
